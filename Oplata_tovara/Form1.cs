    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(txtPurchase.Text) == 0)
                ...
                MessageBox.Show("Вычислите оплату !");
        ...
        private void txtPricePerUnit_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.KeyChar = '\0';
                label8.Text = "Разрешены только цифры";
            }
            else
                label8.Text = "";
        }
        ...
        private void txtQuantity_KeyPress(object sender, KeyPressEventArgs e)
        {
           if ( !char.IsDigit(e.KeyChar) && !char.IsControl(e.KeyChar)
                {
                e.KeyChar= '\0';
                label9.Text = "Разрешены только цифры";
            }
            else
                label9.Text = "";
        }
